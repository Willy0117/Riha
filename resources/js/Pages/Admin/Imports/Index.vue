                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <label
                                ...
                                <template v-if="!file">
                                    <svg class="w-8 h-8 text-muted-foreground/50 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <template v-else>
                                    <svg class="w-7 h-7 text-primary mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    :key="t.value"
                                    type="button"
                                    class="relative text-left rounded-lg border-2 p-4 transition-colors focus:outline-none"
                        ...
                        <div class="flex justify-end gap-2">
                            <Button variant="ghost" :disabled="uploading" @click="clearAll">
                                クリア
                            </Button>
